...
g3.drawCircles = function(ops) {
	...
	var circleGroup = ops.chart.append("g." + ops.groupClass);

	var circles = circleGroup.selectAll("circle")
		.data(ops.data).enter()
		.append("circle")
		.attr("class", d3.f(ops.elClass))
		.attr("cx", g3.compose(ops.xScale, d3.f(ops.xVar)))
		.attr("cy", g3.compose(ops.yScale, d3.f(ops.yVar)))
		.attr("r", ops.r);
...
g3.drawLines = function(ops) {
	...
	var lineGroup = ops.chart.append("g." + ops.groupClass);
...
g3.drawVoronoi = function(ops) {
	...
	var voronoiFunc = d3.geom.voronoi()
		.x(function(d) { return ops.xScale(d[ops.xVar]); })
		.y(function(d) { return ops.yScale(d[ops.yVar]); })
		.clipExtent([[-0.01, -0.01], [ops.width, ops.height]]);

	var voronoiData = voronoiFunc(ops.data);

	var voronoiGroup = ops.chart.append("g." + ops.groupClass);
